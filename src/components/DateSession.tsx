          ...
          {isDatee && finalResults.tokens > 0 && (
            <div className="bg-gradient-to-r from-[#FFB800]/20 to-[#FF6B00]/20 rounded-xl p-4 mb-6 border border-[#FFB800]/30">
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-white/60">Dream Coin earned!</span>
              </div>
            </div>
          )}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-[#FFB800]/10 to-[#FF6B00]/10 rounded-xl border border-[#FFB800]/20">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[#FFB800] font-bold">{session.token_amount} Dream Coin</span>
            </div>
            <p className="text-white/50 text-xs mt-2">
              {isDatee 
                ? 'You\'ll receive this Dream Coin when the date completes!' 
                : 'Dream Coin will be transferred to your date upon completion.'}
            </p>
          </div>
        </div>
      </div>
