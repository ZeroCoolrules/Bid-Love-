...
const CashoutModal: React.FC<CashoutModalProps> = ({
  ...
  const handleRequestCashout = async () => {
    ...
    if (tokenAmount < MIN_CASHOUT_TOKENS) {
      setError(`Minimum cashout is ${MIN_CASHOUT_TOKENS} Dream Coin`);
      return;
    }
        ...
        <div className="sticky top-0 z-10 bg-gradient-to-br from-[#1a1025] to-[#1a1025] p-6 border-b border-white/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Cash Out Tokens</h2>
                <p className="text-white/60 text-sm">Convert Dream Coin to real money</p>
              </div>
            </div>
            <button
              onClick={onClose}
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-white/70 text-sm">Choose how many Dream Coin to cash out (min. 100 Dream Coin)</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-[#00D9FF]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
                    ...
                    <span className="text-white/60">Dream Coin</span>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 rounded-2xl p-5 border border-white/10 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-white/60">Tokens to Withdraw</span>
            ...
            <div className="text-center py-8">
              ...
              {successData && (
                <div className="bg-white/5 rounded-2xl p-5 border border-white/10 mb-6 text-left">
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-white/60">Tokens Withdrawn</span>
