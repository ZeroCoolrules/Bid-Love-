        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-200px)]">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 mb-6">
              ...
              <span className="text-sm text-white/80">The Unified Dating Experience</span>
            </div>
            ...
            <p className="text-xl text-white/70 mb-8 max-w-xl mx-auto lg:mx-0">
              Create your virtual character, unlock Bid Love with your Cupidspoint DatingPro account, and use Dream Coin to win
              dates with compatible matches. Experience romance in a whole new dimension.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 mt-12 pt-8 border-t border-white/10">
              ...
              <div>
                ...
                <div className="text-sm text-white/50">Dream Coin Traded</div>
              </div>
              <div>
                ...
                <div className="mt-4 p-4 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl border border-green-500/20">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-white font-bold">
                      <span className="text-[#FFB800]">175</span> Dream Coin
                    </div>
                  </div>
