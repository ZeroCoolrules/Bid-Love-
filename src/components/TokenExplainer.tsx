...
const TokenExplainer: React.FC = () => {
  const tokenFeatures = [
    {
      icon: WalletIcon,
      title: 'Purchase Dream Coin',
      description: 'Buy Dream Coin with real currency. Prices start at $0.07 per coin with bulk discounts available.',
    },
    {
      icon: TokenIcon,
      title: 'Bid on Dates',
      description: 'Use Dream Coin to bid on date listings. Higher bids increase your chances of being selected.',
    },
    {
      icon: TrendingUpIcon,
      title: 'Earn & Cash Out',
      description: 'Earn Dream Coin from successful dates. Cash out anytime at market rate or reinvest in more dates.',
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative w-full max-w-md mx-auto">
              ...
              <div className="relative z-10 w-64 h-64 mx-auto">
                ...
                <div className="relative w-full h-full bg-gradient-to-br from-[#FFB800] to-orange-500 rounded-full flex items-center justify-center shadow-2xl shadow-[#FFB800]/30">
                  <div className="text-center">
                    ...
                    <p className="text-black/60 text-sm">Dream Coin</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-0 left-0 bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20">
                ...
                <p className="text-[#00D9FF] font-bold">1.2M Dream Coin</p>
              </div>
          ...
          <div>
            ...
            <p className="text-white/60 text-lg mb-8">
              Dream Coin powers our entire ecosystem. Purchase Dream Coin to bid on dates, earn it from successful connections, and cash out whenever you want.
            </p>
