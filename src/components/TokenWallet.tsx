...
const TokenWallet: React.FC<TokenWalletProps> = ({ 
  ...
  const recentTransactions = [
    { type: 'purchase', amount: 500, date: '2 hours ago', description: 'Dreamcoin Purchase' },
    ...
    <section className="py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-4">Dreamcoin Wallet</h2>
          <p className="text-white/60 max-w-2xl mx-auto">
            Manage your Dreamcoin balance. Purchase, track transactions, and cash out your earnings.
          </p>
        </div>
            ...
            <div className="bg-gradient-to-br from-[#FFB800]/20 to-orange-500/10 backdrop-blur-sm rounded-3xl border border-[#FFB800]/30 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-xl">
                  <span className="text-white/60 text-sm">Dreamcoin Value</span>
            ...
            <div className="mt-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">$0.07/Dreamcoin (5% fee)</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-white">1.2M Dreamcoin</span>
                </div>
                <div className="flex justify-between">
            ...
            {activeTab === 'buy' ? (
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold text-white">Purchase Dreamcoin</h3>
                ...
                {purchaseSuccess ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-white/60">Dreamcoin have been added to your wallet</p>
                  </div>
                ) : (
                  <>
                    ...
                    >
                      ...
                      Buy Dreamcoin with Card
                    </button>

                    <p className="text-center text-white/40 text-sm mt-4">
                      Secure payment processing. Dreamcoin are added instantly after purchase.
                    </p>
                  </>
                )}
              </div>
                ...
                {isLoadingHistory ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-white/60 mb-6">
                      Cash out your earned Dreamcoin to receive real money in your bank account.
                    </p>
                    <button
                      onClick={onOpenCashoutModal}
