  ...
  const steps = [
    {
      number: '01',
      icon: UserIcon,
      title: 'Join via DatingPro',
      description: 'Sign up with Cupidspoint DatingPro to sync your profile, preferences, and compatibility history.',
    },
    {
      number: '02',
      icon: SearchIcon,
      title: 'Unlock Bid Love',
      description: 'Jump into the Bid Love marketplace with instant access to curated dates and experiences.',
    },
    {
      number: '03',
      icon: TokenIcon,
      title: 'Spend Dreamcoin',
      description: 'Use Dreamcoin to bid, tip, and reserve premium experiences across the platform.',
    },
    {
      number: '04',
      icon: PlayIcon,
      title: 'Stream the Moment',
      description: 'Step into the redesigned video lounge with live overlays, private chat, and story-driven moments.',
    },
    {
      number: '05',
      icon: ChartIcon,
      title: 'Coordinate & Grow',
      description: 'ClimaxCoordinator keeps scheduling, consent, and aftercare in sync while you track progress.',
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 max-w-2xl mx-auto text-lg">
            From DatingPro sign-up to ClimaxCoordinator follow-through, here is the unified journey.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-4 px-6 py-4 bg-gradient-to-r from-[#00D9FF]/10 to-[#FFB800]/10 rounded-2xl border border-white/10">
            <div className="text-left">
              ...
              <p className="text-white/60 text-sm">Create your profile and get 500 Dreamcoin to start</p>
            </div>
